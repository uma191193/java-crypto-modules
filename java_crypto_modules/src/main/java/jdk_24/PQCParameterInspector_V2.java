...
public class PQCParameterInspector_V2 {
    ...
    static {
        ...
        // No longer standard, but included for historical context.
        OID_MAP.put("1.3.6.1.4.1.2.267.7.6.5", "ML-DSA-44 (Legacy)");
        OID_MAP.put("1.3.6.1.4.1.2.267.7.6.6", "ML-DSA-65 (Legacy)");
        OID_MAP.put("1.3.6.1.4.1.2.267.7.6.7", "ML-DSA-87 (Legacy)");

        OID_MAP.put("2.16.840.1.101.3.4.3.18", "ML-DSA-65 (Legacy/Incorrect)");
    }
    ...
    public static String detectDefaultParam(String familyName) throws Exception {
        ...
        String oid = extractOIDFromX509(encoded);
